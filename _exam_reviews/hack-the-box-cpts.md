...
After spending nearly 10 consecutive days engaged in deep enterprise reconnaissance, chaining multi-stage exploits, double pivoting through segmented networks, and drafting a 134-page commercial-grade report, I secured **85 points (12/14 flags)** and submitted my final deliverable with just two minutes left on the clock.

The CPTS is widely regarded as one of the most grueling, realistic, and rewarding practical security certifications in the industry. In this guide, I break down everything you need to know about the certification: what it is, how it compares to alternatives like the OSCP, how I structured my preparation across two full passes of the HTB Academy curriculum, my exact note-taking and lab strategy, and a transparent, day-by-day walkthrough of my 10-day exam marathon without violating the NDA.
...
The single biggest selling point of HTB Academy is ownership: once you unlock and complete the **Penetration Tester Job Role Path** (28 modules), the material, interactive cheatsheets, and command breakdowns remain accessible on your account permanently.

## 2. Exam Structure & Real-World Realism

The CPTS exam does not feature multiple-choice questions or isolated "CTF-style" puzzles.
...
- **Environment Architecture:** A black-box enterprise perimeter leading into interconnected corporate domains. You will encounter Windows and Linux hosts, Active Directory forests, web applications, internal APIs, and custom services. Multi-hop pivoting is the standard reality once you breach the internal Active Directory environment.
...
- **Pass 2: Granular Mastery & Cheatsheet Creation**  
  *Focus:* Building an operational methodology, mapping out common mistakes and fixes, and organizing searchable payload playbooks.

### Note-Taking Architecture (Notion)

Speed during the exam depends entirely on retrieval time. I used a strict hierarchical structure in **Notion** using the built-in search shortcut:
...
While the Academy path provides the theoretical foundation, practical muscle memory requires external lab environments:
...
- **Active Directory Home Labs:** Prior to sitting the exam, I had built 3 multi-domain Active Directory home labs for personal research. (Note: I did **not** complete any HTB ProLabs or follow the TJNull/IppSec lists specifically; the combination of the Academy path, the CPTS preparation track, and independent box practice was more than sufficient).
...
The first two days were pure reconnaissance. When you are dropped into a massive black-box environment with multiple web properties and open ports, the sheer attack surface is overwhelming. I spent 60+ hours systematically port scanning, fuzzing virtual hosts, identifying API endpoints, and mapping possible attack paths without capturing a single flag.

### Day 3: The Foothold (Flag 1)

On Day 3, my thorough enumeration paid off. An obscure finding on an exposed service allowed me to construct an initial exploit chain, gaining a low-privilege shell on the first machine and unlocking **Flag 1**.

### Days 4 to 6: Momentum (Flags 2 through 7)

Once inside, momentum picked up. I established my tunnels, pivoted into the internal segment, and began moving laterally. I secured 1 to 2 flags each day by combining host privilege escalation, credential dumping, and exploiting internal web applications.
...
With the clock ticking down and only one day left, I halted active exploitation to focus 100% of my remaining energy on the report.

### The Reality of Post-Exploitation Looting

Looting is a double-edged sword during the exam. Finding a new password hash, config file, or private key gives you a massive dopamine rush, but is immediately followed by the mental fatigue of having to test that newly discovered credential across every single previously enumerated authentication endpoint, service, and database. Be prepared for facing the mental exhaustion.
...
3. **Drafting on the Fly:** I drafted individual findings and captured clean screenshots the moment an exploit succeeded. Never leave your report to the final 24 hours.

### The 5-Minute Panic

With barely 10 minutes remaining before the 240-hour exam portal closed forever, I attempted to compile my final 134-page report in SysReptor.

**The rendering engine threw a fatal template parsing error.**

Looking back, those next five minutes were easily some of the most stressful moments of my life. Adrenaline was surging as I scrambled to hunt down the broken Markdown syntax: an unescaped character buried deep inside a code block. With the clock aggressively ticking down and SysReptor refusing to compile the updated file, I couldn't risk debugging any longer.
...
SysReptor will save you hours of formatting friction compared to Word. However, **export and save draft PDF copies locally multiple times a day**. If a rendering engine crashes or an asset breaks near the deadline, you must have a recent, functional PDF ready to submit.

### 3. Complete the HTB Labs CPTS Preparation Track

The modules teach you the theory with decent practice; the CPTS Prep track on HTB Labs teaches you the intuition. Do not skip this track under any circumstances.

### 4. Master Ligolo-ng Before Starting
...
### 5. Clear Your Schedule (10+ Hours/Day)
